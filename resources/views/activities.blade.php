                                    ...
                                    <ul class="activity-list">
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile" title="Lesley Grauer" data-bs-toggle="tooltip" class="avatar">
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile" class="avatar" title="Jeffery Lalor" data-bs-toggle="tooltip">
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile" title="Catherine Manseau" data-bs-toggle="tooltip" class="avatar">
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile" title="Mike Litorus" data-bs-toggle="tooltip" class="avatar">
                                        ...
                                        <li>
                                            <div class="activity-user">
                                                <a href="profile" title="Jeffery Lalor" data-bs-toggle="tooltip" class="avatar">
                                                    <img src="assets/img/profiles/avatar-16.jpg" alt="">
                                                </a>
                                            </div>
                                            <div class="activity-content">
